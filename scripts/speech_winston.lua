...
return {
	...
	ANNOUNCE_SHOVELBLADE_EQUIPONE = "-Let's Get Shoveling-",
	ANNOUNCE_SHOVELBLADE_EQUIPTWO = "-Get Digging-",
	ANNOUNCE_SHOVELBLADE_EQUIPTHREE = "-Strike The Earth-",
	ANNOUNCE_SHOVELBLADE_EQUIPFOUR = "-Justice In Spades-",
	ANNOUNCE_SHOVELBLADE_EQUIPFIVE = "-It's Shoveling Time-",
	ANNOUNCE_SHOVELBLADE_EQUIPSIX = "-Dig In-",
	ANNOUNCE_SHOVELBLADE_EQUIPSEVEN = "-For Shovelry-",
	ANNOUNCE_SHOVELBLADE_EQUIPEIGHT = "-Sharpen Thy Shovel-",
