...
local function onequip(inst, owner) 
    owner.AnimState:OverrideSymbol("swap_body", "skarmorconjurerscoat", "swap_skarmorstalwartplate")
...
STRINGS.CHARACTERS.WINSTON.DESCRIBE.SKARMORCONJURERSCOAT = "Offers basic protect."
